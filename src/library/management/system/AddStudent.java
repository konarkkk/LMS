...
public class AddStudent extends JFrame implements ActionListener{
    ...
    public AddStudent() {
        super("Add Student");
	setBounds(700, 200, 380, 450);
	contentPane = new JPanel();
	contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
	setContentPane(contentPane);
	contentPane.setLayout(null);

	JLabel l1 = new JLabel("College ID");
	...
	comboBox.setModel(new DefaultComboBoxModel(new String[] { "CSAI", "CSE", "CSB", "IT", "Other" }));
	comboBox.setForeground(new Color(47, 79, 79));
	comboBox.setFont(new Font("Trebuchet MS", Font.BOLD, 14));
	comboBox.setBounds(176, 134, 154, 20);
	...
	comboBox_2.setBounds(176, 168, 154, 20);
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                try{
                conn con = new conn();
                String sql = "insert into student(CID, Name, Course, Branch, Semester) values(?, ?, ?, ?, ?)";
